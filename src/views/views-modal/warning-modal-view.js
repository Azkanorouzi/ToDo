...
class WarningModalView extends ModalView {
  ...
  _generateHTML() {
    return `
    <section
    class="absolute top-0 left-0 right-0 bottom-0 bg-theme-${this._assets.curTheme}-forth bg-opacity-5 backdrop-blur-sm z-50 p-4 fade-in-left"
  >
    <div
    ...
    >
      ...
      >
        ...
        <div class="buttons text-center">
          <button
            class="bg-theme-${this._assets.curTheme}-fifth px-6 text-xl py-3 rounded-xl text-theme-${this._assets.curTheme}-forth shadow-2xl border-b-4 border-b-theme-${this._assets.curTheme}-forth focus:border-b-0 transition-all hover:opacity-100 opacity-70"
            type="button"
          >
            Ok
          </button>
          <button
            class="bg-theme-${this._assets.curTheme}-fifth px-6 text-xl py-3 rounded-xl text-theme-${this._assets.curTheme}-forth border-b-4 border-b-theme-${this._assets.curTheme}-forth focus:border-b-0 transition-all hover:opacity-100 opacity-70"
            type="button"
          >
            cancel
          </button>
