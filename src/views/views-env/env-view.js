...
class EnvironmentView extends ContainerTaskView {
  ...
  >
    ...
    >
      <!-- back button -->
      <div class="text-2xl text-theme-${this._assets.curTheme}-fifth cursor-pointer lg:hidden back-button">
        <i class="fa-solid fa-arrow-left"></i>
      </div>
      <!-- Name of the Area -->
      <h1 class="text-2xl font-second text-theme-${this._assets.curTheme}-fifth lg:text-3xl">
        <i class="fa-solid fa-dragon text-theme-${this._assets.curTheme}-third"></i>
        ${this._assets.name}
      </h1>
    </nav>
    <!-- Project container -->
