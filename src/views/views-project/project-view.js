...
class ProjectView extends ContainerTaskView {
  ...
  >
    ...
    >
      ...
      <!-- Name of the project -->
      <h1 class="text-2xl font-second text-theme-${this._assets.curTheme}-fifth lg:text-3xl">
    ...
    <!-- Todos container -->
    <section
      class="text-theme-${this._assets.curTheme}-forth text-1xl flex flex-col gap-2 text-2xl rounded-sm p-5 pt-32 lg:pt-0 2xl:grid xl:grid-cols-2 items-container todo-container"
    >
    </section>
    <!-- Plus button -->
    <div
